...
function em_get_search_form_defaults($args = array()){
	...
	$search_args['search_text_show'] = 'Mostrar opciones avanzadas';
	$search_args['search_text_hide'] = 'Ocultar opciones avanzadas';
	...
	$search_args['search_term'] = 'Buscar';
	...
	$search_args['category_label'] = 'Categoría'; //field label
	...
	$search_args['country_label'] = 'País'; //field label
