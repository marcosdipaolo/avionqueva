...
<div class="em-location-data-nolocation">
	<p>
		<input class="uk-checkbox" type="checkbox" name="no_location" id="no-location" value="1" <?php if( $EM_Event->location_id === '0' || $EM_Event->location_id === 0 ) echo 'checked="checked"'; ?> />
...
<div id="em-location-data" class="em-location-data">
	...
	<table class="em-location-data">
		...
		<tr class="em-location-data-country">
			...
			<td>
				<select class="uk-select" id="location-country" name="location_country">
