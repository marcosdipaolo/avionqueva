...
<p class="em-time-range">
		...
		<?php _e('All day','events-manager'); ?> <input type="checkbox" class="uk-checkbox em-time-allday" name="event_all_day" id="em-time-all-day" value="1" <?php if(!empty($EM_Event->event_all_day)) echo 'checked="checked"'; ?> />
	</p>
