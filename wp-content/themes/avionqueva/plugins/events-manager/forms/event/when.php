...
<div class="event-form-when" id="em-form-when">
	...
	<p class="em-time-range">
		...
		<?php _e('All day','events-manager'); ?> <input type="checkbox" class="uk-checkbox em-time-all-day" name="event_all_day" id="em-time-all-day" value="1" <?php if(!empty($EM_Event->event_all_day)) echo 'checked="checked"'; ?> />
	</p>
